...
export function BudgetsGraph({ budget }: { budget?: BudgetSummary }) {
	if (!budget) return;
	...
	return (
        ...
        <View style={styles.budgetContainer}>
          <View>
            ...
            <ThemedText type="defaultSemiBold">- Spent: {budget.wants_percentage.toFixed(1)}%</ThemedText>
      ...
      <View style={styles.barContainer}>
        ...
        <View style={styles.budgetContainer}>
          <View>
            ...
            <ThemedText type="defaultSemiBold">- Spent: {budget.needs_percentage.toFixed(1)}%</ThemedText>
        ...
        <View style={styles.budgetContainer}>
          <View>
            ...
            <ThemedText type="defaultSemiBold">- Spent: {budget.savings_percentage.toFixed(1)}%</ThemedText>
